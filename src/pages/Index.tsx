        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link to="/contribute">
                <Button variant="outline" size="lg" className="bg-primary-foreground/10 backdrop-blur-sm border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-foreground">
          ...
          {selectedArtist && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-primary font-semibold mb-1">{selectedArtist.artForm}</p>
                <p className="text-muted-foreground mb-4">{selectedArtist.region}</p>
